...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi turquoise
    let backgroundColor = '#40E0D0';  // Turquoise

    // Teks nama warna turquoise dan kalimat warna putih
    let nameColor = '#40E0D0';  // Turquoise
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Turquoise
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna turquoise
            },
            text: text,
