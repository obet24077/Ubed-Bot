...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi maroon
    let backgroundColor = '#800000';  // Maroon

    // Teks nama warna maroon dan kalimat warna putih
    let nameColor = '#800000';  // Maroon
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna maroon
            },
            text: text,
