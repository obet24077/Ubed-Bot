...
const handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    const apiUrl = `https://api.maelyn.tech/api/gemini/image?q=Jawab%20soal%20dalam%20gambar%20pakai%20bahasa%20indonesia&url=${encodeURIComponent(imageUrl)}&apikey=ubed2407`;
