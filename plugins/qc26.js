...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi olive
    let backgroundColor = '#808000';  // Olive

    // Teks nama warna olive dan kalimat warna putih
    let nameColor = '#808000';  // Olive
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Olive
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna olive
            },
            text: text,
