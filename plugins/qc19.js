...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi gold
    let backgroundColor = '#FFD700';  // Gold

    // Teks nama warna gold dan kalimat warna putih
    let nameColor = '#FFD700';  // Gold
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna gold
            },
            text: text,
