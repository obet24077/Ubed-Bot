...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi teal
    let backgroundColor = '#008080';  // Teal

    // Teks nama warna teal dan kalimat warna putih
    let nameColor = '#008080';  // Teal
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna teal
            },
            text: text,
