...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi silver
    let backgroundColor = '#C0C0C0';  // Silver

    // Teks nama warna silver dan kalimat warna putih
    let nameColor = '#C0C0C0';  // Silver
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna silver
            },
            text: text,
