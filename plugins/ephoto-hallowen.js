...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    let apiUrl = `https://beforelife.me/api/ephoto/hallowen?text=${query}&apikey=ubed2407`;
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: response.data,
            caption: `✅ *Gambar Halloween berhasil dibuat!*\n📌 *Teks:* ${text.trim()}`,
        }, { quoted: m });
        ...
        await conn.sendMessage(m.chat, { react: { text: "❌", key: m.key } });
        throw `❌ Terjadi kesalahan saat membuat gambar Halloween.\n\n🔍 *Error:* ${e.message || e}`;
    }
};

handler.help = ["hallowen"];
handler.tags = ["fun"];
