...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi hitam
    let backgroundColor = '#000000'; 

    // Teks nama warna biru dan kalimat warna putih
    let nameColor = '#0000FF';  // Biru
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Hitam
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna biru
            },
            text: text,
