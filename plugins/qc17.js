...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi kuning
    let backgroundColor = '#FFFF00';  // Kuning

    // Teks nama warna kuning dan kalimat warna putih
    let nameColor = '#FFFF00';  // Kuning
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Kuning
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna kuning
            },
            text: text,
