...
let handler = async (m, { conn, args, text, usedPrefix, command }) => {
  ...
  let defaultPrompt = "Buatkan Karakter Yang Ada Di Gamabar Tersebut Agar Di Berikan Hijab Warna Putih Hijab Ala Orang Indonesia Dan Buat Jangan Sampai Rambutnya Terlihat Buay Semua Tertutup";
