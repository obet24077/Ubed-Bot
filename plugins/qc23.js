...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi coral
    let backgroundColor = '#FF7F50';  // Coral

    // Teks nama warna coral dan kalimat warna putih
    let nameColor = '#FF7F50';  // Coral
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Coral
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna coral
            },
            text: text,
