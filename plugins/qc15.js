...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi cyan
    let backgroundColor = '#00FFFF';  // Cyan

    // Teks nama warna cyan dan kalimat warna putih
    let nameColor = '#00FFFF';  // Cyan
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna cyan
            },
            text: text,
