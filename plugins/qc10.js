...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi merah
    let backgroundColor = '#FF0000'; // Merah

    // Teks nama warna hitam dan kalimat putih
    let nameColor = '#000000';  // Hitam
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Merah
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna hitam
            },
            text: text,
