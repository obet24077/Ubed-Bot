...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi ungu
    let backgroundColor = '#800080';  // Ungu

    // Teks nama warna ungu dan kalimat warna putih
    let nameColor = '#800080';  // Ungu
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Ungu
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna ungu
            },
            text: text,
