...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi lime
    let backgroundColor = '#00FF00';  // Lime

    // Teks nama warna lime dan kalimat warna putih
    let nameColor = '#00FF00';  // Lime
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna lime
            },
            text: text,
