...
if (command == 'sewapanel') {
  let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
    let name = await conn.getName(who)
    let caption = `👋 ʜᴀɪ *${name} @${who.split("@")[0]}*,

*• sᴇᴡᴀ ᴘᴀɴᴇʟ & ᴀᴅᴍɪɴ ᴘᴀɴᴇʟ•*
        
𝟷. ᴘᴀɴᴇʟ ᴜɴʟɪ/ 𝟹𝟶 ʜᴀʀɪ
ʀᴘ. 𝟷𝟶.𝟶𝟶𝟶 ᴅᴀɴᴀ
ʀᴘ. 𝟷𝟶.𝟶𝟶𝟶 ᴘᴜʟsᴀ

𝟸.  ᴀᴅᴍɪɴ ᴘᴀɴᴇʟ/ 𝟹𝟶 ʜᴀʀɪ
ʀᴘ. 𝟷𝟻.𝟶𝟶𝟶 ᴅᴀɴᴀ
ʀᴘ. 𝟷𝟻.𝟶𝟶𝟶 ᴘᴜʟsᴀ
...
handler.command = ['sewapanel', 'mengproduk', 'mengorder', 'mengfake', 'menggrup', 'mengpay']
