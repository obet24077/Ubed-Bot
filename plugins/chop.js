    ...
    try { 
        ...
        if (global.db.data.users[m.sender].healt > 79) {
            if (new Date - global.db.data.users[m.sender].lastmining > 180000) {
                ...
                // Menghitung bonus kesehatan berdasarkan kucing dan armor
                ...
                // Menghitung potions dan item lainnya
                ...
                // Memberitahukan hasil pemotongan
                conn.reply(m.chat, '↓Pemotongan:', m)
                let str = `
