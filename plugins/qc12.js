...
const handler = async (m, { conn, args, command }) => {
    ...
    let backgroundColor = '#008000';  // Hijau

    // Teks nama warna hijau dan kalimat warna putih
    let nameColor = '#008000';  // Hijau
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna hijau
            },
            text: text,
