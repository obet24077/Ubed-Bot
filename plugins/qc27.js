...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi snow
    let backgroundColor = '#FFFAFA';  // Snow

    // Teks nama warna snow dan kalimat warna putih
    let nameColor = '#FFFAFA';  // Snow
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna snow
            },
            text: text,
            textColor: textColor, // Kalimat berwarna hitam
            replyMessage: {}
        }]
    };
