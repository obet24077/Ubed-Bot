...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi orange
    let backgroundColor = '#FFA500';  // Orange

    // Teks nama warna orange dan kalimat warna putih
    ...
    const obj = {
        ...
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna orange
            },
            text: text,
