...
const handler = async (m, { conn, args, command }) => {
    ...
    // Ganti warna latar belakang menjadi coklat
    let backgroundColor = '#A52A2A';  // Coklat

    // Teks nama warna coklat dan kalimat warna putih
    let nameColor = '#A52A2A';  // Coklat
    ...
    const obj = {
        type: "quote",
        format: "png",
        backgroundColor: backgroundColor, // Coklat
        width: 512,
        height: 768,
        scale: 2,
        messages: [{
            ...
            from: {
                ...
                photo: { url: pp },
                textColor: nameColor // Nama berwarna coklat
            },
            text: text,
